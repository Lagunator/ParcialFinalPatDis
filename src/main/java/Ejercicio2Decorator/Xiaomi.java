...
public class Xiaomi implements IPhone {
    ...
    public Xiaomi(String modelo, int precio, double androidVersion, int memoriaRam, String store, int numeroChips, double buildVersion) {
        this.modelo = modelo;
        this.precio = precio;
    ...
    public void agregarFuncionalidad() {
        System.out.println(">>>>>> Agregando las funcionlidades <<<<<<");
        System.out.println("Caracteristicas actuales.- ");
        System.out.println("Modelo: "+getModelo());
        System.out.println("Precio: "+getPrecio());
        System.out.println("Version de android: "+getAndroidVersion());
